defmodule Hiwi.Queues do
    ...
    # --- INI FUNGSI YANG KAMU BUTUHKAN (SAYA TAMBAHKAN DISINI) ---
    @doc """
    Mereset current_number antrian kembali ke 0.
    Dipanggil oleh QueueController.reset_number
    """
    def reset_queue_number(%Queue{} = queue) do
        # 1. Ambil prefix lama (misal "A10")
        ...
        |> Ecto.Changeset.change(%{
             current_number: 0,
             prefix: new_prefix  # Update prefix baru yang sudah bersih dari angka
           })
        |> Repo.update()
      end
