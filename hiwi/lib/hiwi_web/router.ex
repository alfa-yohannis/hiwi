defmodule HiwiWeb.Router do
    ...
    # --- QUEUE MANAGEMENT ---
  # Perhatikan: scope ini menggunakan "HiwiWeb.Queue", jadi otomatis mencari controller dengan nama "HiwiWeb.Queue.*"
  scope "/queues", HiwiWeb.Queue do
    ...
    # --- INI YANG PENTING: RUTE RESET ---
    # Karena sudah di dalam scope "/queues", kita cukup tulis "/:id/reset"
    ...
    scope "/", HiwiWeb do
        ...
        put "/queues/:id/reset", QueueController, :reset_number # <-- TAMBAHKAN INI
    end
